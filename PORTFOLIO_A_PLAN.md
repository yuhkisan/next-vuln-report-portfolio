...
2. **プロジェクト操作の永続化**: 名前変更/削除の実装
3. **チーム状態の統一**: URL/Cookie で teamId を一貫管理
4. **依存グラフ拡張**: Dependency Path の精度向上
5. **CI/CD**: GitHub Actions で lint/test/build を自動化
